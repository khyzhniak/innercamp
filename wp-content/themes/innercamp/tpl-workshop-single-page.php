<?php
/**
* Template Name: WorkShop single Page*
*
*/
get_header(); ?>
        ...
        <div class="row">
          <div class="col m12 s12 l3 xl3">
            <div class="box__"><a class="bundle" href="javascript:;">Book now</a>
              <ul>
                <li class="active"> <a href="#">Workshop details</a></li>
                <li> <a href="#">Course basics</a></li>
                <li> <a href="#">Facilitators</a></li>
                <li> <a href="#">InnerCamp membership</a></li>
                <li> <a href="#">How to get ready?</a></li>
                <li> <a href="#">Workshop participant consent</a></li>
                <li> <a href="#">FAQ</a></li>
              </ul>
            </div>
          </div>
...
<section class="workshop__2">
  <div class="container">
    <div class="row">
      <div class="col m12 s12 l12 xl9 offset-xl3"><span class="notice">Join the InnerCamp Community to get access to this virtual workshop.</span>
        <div class="card">
          <div class="card-body">
            <div class="img">
